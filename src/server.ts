...
app.post(withBase("/api/auth/request-code"), async (req: Request<{}, AuthResponse, AuthRequest>, res: Response<AuthResponse>) => {
...
app.post(withBase("/api/auth/verify-code"), (req: Request<{}, AuthResponse, AuthRequest>, res: Response<AuthResponse>) => {
...
app.post(withBase("/api/tts"), requireAuth, async (req: Request<{}, any, TTSRequest>, res: Response) => {
...
app.post(withBase("/api/phrases"), requireAuth, (req: Request<{}, PhraseResponse, PhraseRequest>, res: Response<PhraseResponse>) => {
...
app.delete(withBase("/api/phrases/:phrase"), requireAuth, (req: Request, res: Response<PhraseResponse>) => {
...
app.post(withBase("/api/cache-combined"), requireAuth, upload.single('audio'), async (req: Request, res: Response) => {
...
app.post(withBase("/api/check-combined"), requireAuth, (req: Request<{}, CombinedAudioResponse, CombinedAudioRequest>, res: Response<CombinedAudioResponse>) => {
  const { text } = req.body;
